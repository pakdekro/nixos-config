...

{
  ...
  # Luks swap unlock fix (fixes 1m30s boot delay)
  boot.initrd.luks.devices."luks-dd68e6d0-e8fd-4445-9645-960caa375329".device = "/dev/disk/by-uuid/dd68e6d0-e8fd-4445-9645-960caa375329";
  ...
  services.avahi = {
    enable = true;
    nssmdns4 = true; # Essentiel pour la résolution de noms locaux (.local)
    publish = {
      enable = true;
      userServices = true;
    };
  ...
  # Services pour le montage automatique (clés USB, etc.) et partages réseau
